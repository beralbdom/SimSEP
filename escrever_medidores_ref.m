...
% Escreve os elementos da coluna da matriz 'pot_ativa' e  substitui na coluna 11 do arquivo 'S1_CS01_39M.med';
% Gera 24 arquivos do tipo "S1_CS01_39M-Y.txt", onde Y corresponde às horas;

% Escreve medidores: De, Para, Tipo, ACC, FS e REF na planilha 'Simulador de Medidas_II.xls';
% Escreve essas informações para as 24 horas do dia nas abas do tipo "SimMedidasConv_Z", onde Z corresponde às horas.
...
for plan = 1:24;
    ...
    aba_plan = strcat('SimMedidasConv_', int2str(plan));
...
% ------------- Escrevendo no Simulador de Medidas_II.xlsx -------------- %    
    xlswrite('Simulador de Medidas_II.xlsx', transp(medidores.de), aba_plan,   'A5:A43');
    xlswrite('Simulador de Medidas_II.xlsx', transp(medidores.para), aba_plan, 'B5:B43');
    xlswrite('Simulador de Medidas_II.xlsx', transp(medidores.tipo), aba_plan, 'C5:C43');
    xlswrite('Simulador de Medidas_II.xlsx', transp(medidores.acc), aba_plan,  'D5:D43');
    xlswrite('Simulador de Medidas_II.xlsx', transp(medidores.fs), aba_plan,   'E5:E43');
    xlswrite('Simulador de Medidas_II.xlsx', transp(medidores.ref), aba_plan,  'G5:G43');
