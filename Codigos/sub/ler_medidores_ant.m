...
[dados,count] = fscanf(fid, '%g', [11, inf]);
...
for i = 1 : coluna
    medidores.num(i) = (i);
    medidores.de(i) = dados(1,i);
    medidores.para(i) = dados(2,i);
    medidores.circ(i) = dados(3,i);
    medidores.tipo(i) = dados(4,i);
    medidores.PMU_num(i) = dados(5,i);
    medidores.ok(i) = dados(6,i);
    medidores.acc(i) = dados(7,i);
    medidores.fs(i) = dados(8,i);
    medidores.dp(i) = dados(9,i);
    medidores.ref(i) = dados(10,i);
    medidores.leitura(i) = dados(11,i);
end
